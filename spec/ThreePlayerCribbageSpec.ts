...
describe('Test a Cribbage game between three players', function() {
    ...
    beforeEach(function() {
        ...
        game = new Cribbage(
            new Players<CribbagePlayer>([playerOne, playerTwo, playerThree])
        );
        game.initializeGame();
    });
    ...
    it('sets the next player in the sequence correctly', function() {
        ...
        expect(game.nextPlayerInOrder(playerTwo).equalsOther(playerThree)).toBe(
            true
        );
        expect(game.nextPlayerInOrder(playerThree).equalsOther(playerOne)).toBe(
            true
        );
    });
    ...
    it('removes a player from play if they play their last card', function() {
        ...
        playerThree.hand = new CribbageHand([
            tenOfClubs,
            tenOfDiamonds,
            fiveOfClubs,
            fiveOfDiamonds,
        ...
        game.giveToKitty(
            playerOne.name,
            new ItemCollection<BaseCard>([twoOfDiamonds])
        );
        game.giveToKitty(
            playerTwo.name,
            new ItemCollection<BaseCard>([queenOfClubs])
        );
        game.giveToKitty(
            playerThree.name,
            new ItemCollection<BaseCard>([tenOfClubs])
        );
    ...
    describe('Test with fixed hands, starting at 0 points', function() {
        beforeEach(function() {
            ...
            game.giveToKitty(
                playerTwo.name,
                new ItemCollection<BaseCard>([kingOfHearts])
            );
            game.giveToKitty(
                playerThree.name,
                new ItemCollection<BaseCard>([threeOfHearts])
            );
            game.kitty.takeCard(fourOfClubs);
    ...
    describe('Test an entire round of play', function() {
        ...
        it('knows how to play one round', function() {
            ...
            game.giveToKitty(
                playerOne.name,
                new ItemCollection([sevenOfDiamonds])
            );
            game.giveToKitty(
                playerTwo.name,
                new ItemCollection([kingOfHearts])
            );
            game.giveToKitty(
                playerThree.name,
                new ItemCollection([threeOfHearts])
            );
            game.kitty.takeCard(fourOfClubs);
            game.cut = new BaseCard(Suit.Spades, Value.King);
            game.playersInPlay.addItems(game.players.items);
        ...
        it('knows how to play one round', function() {
            ...
            game.giveToKitty(
                playerOne.name,
                new ItemCollection([nineOfDiamonds])
            );
            game.giveToKitty(
                playerTwo.name,
                new ItemCollection([jackOfHearts])
            );
            game.giveToKitty(
                playerThree.name,
                new ItemCollection([threeOfHearts])
    ...
    describe("Test player playing cards after other player says 'go'", function() {
        ...
        it('sets the next player correctly', function() {
            ...
            game.giveToKitty(
                playerTwo.name,
                new ItemCollection([kingOfSpades])
            );
            game.giveToKitty(
                playerThree.name,
                new ItemCollection([kingOfHearts])
            ...
            expect(function() {
                ...
                ErrorStrings.FMT_NOT_NEXT_PLAYER +
                    ' + ' +
                    game.nextPlayerInSequence.name
            );
        });
        ...
        it('sets the next player correctly when a player gets a go and has no more cards but the opponent does', function() {
            ...
            game.giveToKitty(
                playerTwo.name,
                new ItemCollection([fiveOfHearts])
            );
            game.giveToKitty(
                playerThree.name,
                new ItemCollection([twoOfClubs])
            );
            game.kitty.takeCard(fourOfClubs);
        ...
        it('sets the next player correctly after a go', function() {
            ...
            game.playCard(playerOne.name, aceOfDiamonds);
            game.go(playerTwo.name);
            expect(game.nextPlayerInSequence.equalsOther(playerThree)).toBe(
                true
            );
            game.go(playerThree.name);
            game.playCard(playerOne.name, aceOfSpades);
