...
import {
    ...
    eightOfClubs, eightOfHearts, eightOfSpades,
    fiveOfClubs, fiveOfDiamonds, fiveOfHearts, fiveOfSpades, fourOfClubs, fourOfDiamonds, fourOfHearts, fourOfSpades,
    jackOfHearts, jackOfSpades,
    kingOfHearts, kingOfSpades,
    nineOfDiamonds, nineOfHearts,
    ...
    tenOfClubs, tenOfDiamonds, threeOfHearts, threeOfSpades, twoOfClubs, twoOfDiamonds,
} from './StandardCards';

describe('Test a Cribbage game between three players', function () {
    let game, playerOne, playerTwo, playerThree;
    beforeEach(function () {
